    ...
    <div className="app">
      ...
      <section className="about-section">
        <div className="section-content">
          ...
          <p>Welcome to the AstorAI website, your gateway to accurate and reliable medical information. Our user-friendly interface and advanced search functionality make it easy for you to navigate and find the answers you need. Engage with AstorAI through our interactive chatbot for real-time, detailed responses to your medical questions. We prioritize your privacy and security, ensuring all interactions and personal information are kept confidential. Explore our educational resources and discover how AstorAI can assist you on your health journey.</p>
        </div>
      </section>
        ...
        <div className="section-content">
          ...
          <div className="features-list">
            <div className="feature-card">
              <h4>Accurate Medical Information</h4>
              <p>AstorAI provides reliable answers to a wide range of medical questions, leveraging the power of the advanced LLama 3 model and a custom-trained dataset.</p>
            </div>
            <div className="feature-card">
            ...
            <div className="feature-card">
              ...
              <p>AstorAI prioritizes your privacy, ensuring all interactions are encrypted and no personal data is stored, so you can trust that your information is secure.</p>
            </div>
            <div className="feature-card">
